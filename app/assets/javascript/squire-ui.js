$(document).ready(function() {
  ...
  SquireUI = function(options) {
    ...
    iframe.addEventListener('load', function() {
      ...
      doc.open();
      doc.write('<link rel="stylesheet" href="/assets/stylesheets/bootstrap.min.css">');
      doc.close();
  ...
  SquireUI({replace: ".squire-replace"});
});
/*! drop 0.5.4 */
